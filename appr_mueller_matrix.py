...
def appr_mueller_matrix(matrix_name: str, main_matrix: Matrix) -> tuple[Matrix, str]:
    ...
    if minimum_qm_0 >= 0 and first_column_is_stokes_0 == True:
        ...
        while s > 1 / (2 ** 12):
            ...
            print(f"The minimum of the function q({k}E_11+{matrix_name}) of ({k}E_11+{matrix_name}) is: {minimum_qm}.")
        ...
        print(f"The minimum of the function q{matrix_name}(mu) of {matrix_name}(mu) is {minimum_qm_1}")
